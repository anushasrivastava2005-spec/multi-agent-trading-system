"""
Agent for making final trade decisions. Combines indicator, pattern, and trend reports
to issue a LONG or SHORT order with justification and risk-reward ratio.
"""


def create_final_trade_decider(llm):
    """
    Create a trade decision agent node. The agent uses LLM to synthesize
    indicator, pattern, and trend reports and outputs a final trade decision.
    """
